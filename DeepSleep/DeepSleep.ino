...
{
  0xEA, 0xC4, 0xA9, 0x87, 0x97, 0x5C, 0x6E, 0xEA, 0x1D, 0xD6, 0xDB, 0x09, 0x63, 0xE5, 0x82, 0x39
};
...
{
  0x49, 0xFB, 0x1D, 0x3A, 0x39, 0xA7, 0x4B, 0x4D, 0x62, 0xF5, 0x09, 0x7D, 0x2F, 0x1E, 0xA8, 0x82
};

// OTAA (device EUI) - use msb formatting
// With using the GetHWEUI() function the HWEUI will be used
static uint8_t DevEUI[8]
{ 0x00, 0x04, 0xA3, 0x0B, 0x00, 0x24, 0xDA, 0xD8 };

const uint8_t AppEUI[8] =
{ 0x70, 0xB3, 0xD5, 0x7E, 0xD0, 0x02, 0xAB, 0x85 };

const uint8_t AppKey[16] =
{ 0x2D, 0x63, 0x3D, 0xC2, 0xFB, 0xF5, 0x67, 0x6F, 0xB6, 0x0E, 0x64, 0xF9, 0x30, 0xE7, 0x07, 0x35 };
